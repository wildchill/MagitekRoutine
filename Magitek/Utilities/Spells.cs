...
namespace Magitek.Utilities
{
    internal static class Spells
    {
        ...
        public static readonly SpellData MidareSetsugekka = DataManager.GetSpellData(7867);
        public static readonly SpellData KaeshiSetsugekka = DataManager.GetSpellData(16483);
        public static readonly SpellData TenkaGoken = DataManager.GetSpellData(7867);
        public static readonly SpellData KaeshiGoken = DataManager.GetSpellData(16483);
        public static readonly SpellData Higanbana = DataManager.GetSpellData(7867);
        public static readonly SpellData KaeshiHiganbana = DataManager.GetSpellData(16483);
